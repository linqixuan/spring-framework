...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public ConfigurableEnvironment getEnvironment() {
		if (this.environment == null) {
			// 创建环境变量 org.springframework.context.support.AbstractApplicationContext.createEnvironment
	...
	protected ConfigurableEnvironment createEnvironment() {
		// customizePropertySources会往资源列表中添加Java进程中的变量和系统的环境变量
	...
	protected void prepareRefresh() {
		...
		// 检查环境变量
		// org.springframework.core.env.AbstractPropertyResolver.validateRequiredProperties 为空的时候就抛异常，然后停止启动Spring
